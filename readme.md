...
```html
<link href="https://unpkg.com/shido@^2.2.1/dist/css/shido.min.css" rel="stylesheet">
```

```html
<link href="https://cdn.jsdelivr.net/npm/shido@^2.2.1/dist/css/shido.min.css" rel="stylesheet">
```
