...
```html
<link href="https://unpkg.com/shido@^3.0.7/dist/css/shido.min.css" rel="stylesheet">
```

```html
<link href="https://cdn.jsdelivr.net/npm/shido@^3.0.7/dist/css/shido.min.css" rel="stylesheet">
```
